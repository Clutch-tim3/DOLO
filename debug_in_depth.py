...
async def debug():
    ...
    supplier_name = "HENRY SCHEIN, INC."
    print(f"\n--- USING INCUMBENT SUPPLIER: {supplier_name} ---")
    ...
    print(f"LV Cabling Probability (Incumbent): {prob_lv*100:.2f}%")
    print(f"RFB Comms Probability (Incumbent): {prob_comms*100:.2f}%")
    print(f"Variance: {abs(prob_lv - prob_comms)*100:.2f} points")
