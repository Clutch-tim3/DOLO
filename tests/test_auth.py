...
PROTECTED = [
    ...
    # The Autofill Vault. Eleven routes, every one of which resolves a company
    # and one of which spends money on a paid external API.
    ("POST", "/api/autofill-packs"),
    ("GET", "/api/autofill-packs"),
    ("PATCH", "/api/autofill-packs/any-pack"),
    ("POST", "/api/autofill-packs/any-pack/files"),
    ("DELETE", "/api/autofill-packs/any-pack/files/any-file"),
    ("POST", "/api/autofill-packs/any-pack/submit"),
    ("GET", "/api/autofill-packs/any-pack/status"),
    ("GET", "/api/autofill-packs/any-pack"),
    ("POST", "/api/autofill-packs/any-pack/acknowledge"),
    ("POST", "/api/autofill-packs/any-pack/confirm-values"),
    ("POST", "/api/autofill-packs/any-pack/export"),
